...
wget --directory-prefix "$OUT" https://ai2-semanticscholar-cord-19.s3-us-west-2.amazonaws.com/2020-05-01/comm_use_subset.tar.gz
echo "downloading non-commercial use subset"
wget --directory-prefix "$OUT" https://ai2-semanticscholar-cord-19.s3-us-west-2.amazonaws.com/2020-05-01/noncomm_use_subset.tar.gz
echo "downloading custom license subset"
wget --directory-prefix "$OUT" https://ai2-semanticscholar-cord-19.s3-us-west-2.amazonaws.com/2020-05-01/custom_license.tar.gz
echo "downloading bioRxiv/medRxiv subset"
wget --directory-prefix "$OUT" https://ai2-semanticscholar-cord-19.s3-us-west-2.amazonaws.com/2020-05-01/biorxiv_medrxiv.tar.gz
echo "downloading metadata file"
wget --directory-prefix "$OUT" https://ai2-semanticscholar-cord-19.s3-us-west-2.amazonaws.com/2020-12-04/metadata.csv
